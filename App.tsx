        ...
        <div className="w-full max-w-2xl mt-10 relative">
          ...
          >
            ...
            <div className="relative z-10 space-y-8 letter-content text-gray-700 text-lg md:text-xl leading-relaxed">
              ...
              <p>
                好吧我们算下来也有超过10年了， 写那种催情手信也写不出什么（hmmm可能都写过了？idk）但是还是觉得有点不好意思 我到最后还是选择在kl读书 hmmmm 毕竟之前和你讲过我在png。 想知道原因嘛 你应该也知道吧 but我不知道你知道是什么原因 so你来问我也行嘿嘿。虽然我感觉你应该是不后悔选择ipg 可是感觉那边有点像监狱 还是说声加油吧 可是回想你过来我宿舍玩的时候 超爽的 然后你是第一个发现他喜欢我因为我自己也不知道哇哈哈哈哈哈哈。也当我军师也让我开窍了不少（就和我讲xinwei肯定对我有感觉嘿嘿）不然我觉得我收获不到恋爱了
              </p>
